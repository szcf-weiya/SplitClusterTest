...
Now, let's use our DS procedure to automatically identify which features distinguish the two clusters:
...
Measure the accuracy of the selected set, where the true Non-null features are `1:20`:
